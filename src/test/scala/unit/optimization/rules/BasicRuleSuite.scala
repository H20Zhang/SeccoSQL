...
//    val expr = R1.join(R2).join(R3).join(R4).logical
//    val optimizedExpr =
...
//    val expr = R1.union(R2).union(R3).union(R4).logical
...
//    val expr =
//      R1.join(R2, R3, R4).select("A < B").select("B < C").logical
//
//    val optimizedExpr =
...
//    val expr = R1.join(R2, R3, R4).project("A, B, C").logical
//
//    val optimizedExpr =
