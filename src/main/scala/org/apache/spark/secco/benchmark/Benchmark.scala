...
//
//  /** load the data */
//  protected def loadData(path: String): Map[String, Dataframe]
//
//  /** preprocess the data */
...
//  protected def genQuery(inputData: Map[String, Dataframe]): Dataframe
//
...
//  }
//
//  /** Return the [[Dataframe]] of the query to be tested */
//  def query(path: String): Dataframe = {
//
//    //init Session
//    val sc = dlSession.sparkContext
//
...
//
//  override protected def loadData(path: String): Map[String, Dataframe] = {
//    relationsWithAddress.map { case (catalogTable, suffix) =>
//      val dataPath = s"${path}/${suffix}"
//      val rdd = DataLoader.loadTSV(dataPath)
//
//      (catalogTable.tableName, Dataframe.fromRDD(rdd, catalogTable, dlSession))
//    }
//  }
//
...
//  }
//
//  override protected def genQuery(
//      inputData: Map[String, Dataframe]
//  ): Dataframe = {
//    val datasets = inputData.values.toSeq
//    val joinedTable = datasets.reduceLeft[Dataframe] {
//      case (l: Dataframe, r: Dataframe) => l.join(r)
//    }
//
//    joinedTable
//  }
