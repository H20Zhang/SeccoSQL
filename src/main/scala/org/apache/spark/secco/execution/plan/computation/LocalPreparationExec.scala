...
//import org.apache.spark.secco.execution.plan.computation.utils.{Alg, ArrayTrie, ConsecutiveRowArray, InternalRowHashMap, LexicalOrderComparator}
...
//import org.apache.spark.secco.execution.plan.communication.{ArrayPartition, ArrayIndexedPartition, HashMapData, InternalPartition, RawArrayData, TrieData}
//
...
//          block match {
//
//            case ArrayIndexedPartition(output, shareVector, blockContent) =>
...
//                TrieData(trie)
//              )
//            case ArrayPartition(output, blockContent) =>
//              val content = blockContent.content
//              val schema = output
//
////              Alg.reorder(attributeOrder, schema, content)
