...
//      case Some(childRDD) => childRDD.asInstanceOf[RDD[InternalPartition]]
//      case None =>
...
//    }
//
//  private var hashMapRDDOption: Option[RDD[InternalPartition]] = None
//
...
//
//  def genPartitionRDD(
//      rdd: RDD[InternalPartition],
//      sentryRDD: RDD[(OldInternalRow, Boolean)]
//  ): RDD[InternalPartition] = {
//    val rowRDD = rdd.flatMap {
//      case r: ArrayPartition => r.blockContent.content.map(f => (f, true))
//      case _ =>
...
//          Iterator(
//            ArrayPartition(outputOld, ArrayData(content))
//              .asInstanceOf[InternalPartition]
//          )
//        }
//
//    partitionedRDD
//  }
//
//  def genHashMapRDD(rdd: RDD[InternalPartition]): RDD[InternalPartition] = {
//    rdd.map {
//      case r: ArrayPartition =>
...
//
//  def genZippedRDD(
//      rdd1: RDD[InternalPartition],
//      rdd2: RDD[InternalPartition]
//  ): RDD[InternalPartition] = {
...
//
//  def update(
//      zippedRDD: RDD[InternalPartition]
//  ): (RDD[InternalPartition], RDD[InternalPartition]) = {
//
//    /** cache zippedRDD */
////    zippedRDD.cache().count()
//
//    val diffRDD = zippedRDD.map {
//      case m: MultiPartition =>
//        val block0 = m
//          .subBlocks(0)
//          .asInstanceOf[GeneralPartition[
//            mutable.HashMap[mutable.WrappedArray[
//              OldInternalDataType
//            ], OldInternalDataType]
//          ]]
//        val block1 = m.subBlocks(1).asInstanceOf[ArrayPartition]
//
...
//        }
//
//        block0.asInstanceOf[InternalPartition]
//      case _ => throw new Exception("blockType not supported")
//    }
//
//    /** uncache zippedRDD */
...
//
//  private var iter = 0
//  private var checkpointRDDOption: Option[RDD[InternalPartition]] = None
//
//  /** Perform the computation for computing the result of the query as an `RDD[InternalBlock]`
//    *
//    * Overridden by concrete implementations of SparkPlan.
...
//      MultiPartition(block1.output, Seq(block1, block2))
//    }
//  }
//
//}
