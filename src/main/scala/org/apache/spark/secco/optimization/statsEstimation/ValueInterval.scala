...
import org.apache.spark.secco.optimization.statsEstimation.EstimationUtils
import org.apache.spark.secco.types.{BinaryType, DataType, StringType}
/*
...
//		case StringType | BinaryType => new DefaultValueInterval()
		case StringType => new DefaultValueInterval()
	...
	def isIntersected(r1: ValueInterval, r2: ValueInterval): Boolean = (r1, r2) match {
		...
		case _ =>
			throw pairUnsupportedAtFunctionError(r1, r2, "isIntersected")
	}
	...
	def intersect(r1: ValueInterval, r2: ValueInterval, dt: DataType): (Option[Any], Option[Any]) = {
		(r1, r2) match {
			...
			case _ =>
				throw pairUnsupportedAtFunctionError(r1, r2, "intersect")
		}
	}
}
